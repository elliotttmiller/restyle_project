...
- **Credentials File**: `silent-polygon-465403-h9-81cb035ed6d4.json`
...
gcloud auth activate-service-account --key-file=silent-polygon-465403-h9-81cb035ed6d4.json
...
GOOGLE_APPLICATION_CREDENTIALS=/path/to/silent-polygon-465403-h9-81cb035ed6d4.json
...
```yaml
environment:
  - GOOGLE_APPLICATION_CREDENTIALS=/app/silent-polygon-465403-h9-81cb035ed6d4.json
